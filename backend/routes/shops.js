...
const { getShops, getShop, createShop, updateShop, deleteShop, getFeaturedShops, getShopsByArea, getShopsByCategory, searchShops } = require('../controllers/shopController');
